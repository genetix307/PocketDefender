...
if store.current_frame = 2 {store.current_frame +=1 character = "Vance" dialogue = "So you managed to take down the Dark One. I must say I am impressed Adalas." exit}

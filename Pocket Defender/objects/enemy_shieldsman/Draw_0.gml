...
if hp < max_hp
{
draw_rectangle_colour(x-26,y-32,x+26,y-28,c_black,c_black,c_black,c_black,false)
draw_rectangle_colour(x-25,y-31,x-25+((hp/max_hp)*50),y-29,c_red,c_maroon,c_red,c_maroon,false)
}

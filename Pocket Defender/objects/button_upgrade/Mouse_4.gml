...
//Speed
if upgrade_info_panel.upgrade = "Reload Speed" and store.coins >= store.upgrade_speed_cost and store.reload > 5
{
audio_play_sound(sfx_upgrade,1,false)
store.reload -= 1
store.coins -= store.upgrade_speed_cost
store.upgrade_speed_cost += 250
...
store.upgrade_knockback_cost += 150
...
//Critical
if upgrade_info_panel.upgrade = "Critical Chance" and store.coins >= store.upgrade_critical_cost and store.critical < 50
{
audio_play_sound(sfx_upgrade,1,false)
store.critical += .5
store.coins -= store.upgrade_critical_cost
store.upgrade_critical_cost += 150
upgrade_info_panel.cost = string(store.upgrade_critical_cost)
upgrade_info_panel.current_value = string(store.critical)
upgrade_info_panel.next_value = string(store.critical+.5)+"%"
}
...
upgrade_info_panel.next_value = string(store.max_mp+5)
}
...
upgrade_info_panel.next_value = string(store.max_hp+5)
}
...
store.upgrade_mpregen_cost += 100
...
store.upgrade_hpregen_cost += 100
...
store.upgrade_lightning_cost += 125
...
store.upgrade_northturret_cost = store.turret_north_level*300
...
store.upgrade_southturret_cost = store.turret_south_level*300

...
if store.current_frame = 3 {store.current_frame +=1 character = "story" dialogue = "You've done a great job helping Adalas defend the wall so far! If you enjoy Soul Defender please consider leaving a review & rating!" exit}
